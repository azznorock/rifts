...
This system is a rifts system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

Before installing this system, you should rename any files that have `rifts` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `rifts` and `Rifts` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3Rifts System](https://gitlab.com/asacolips-projects/foundry-mods/vue3rifts) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/rifts.png)
